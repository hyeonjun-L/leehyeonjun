...
const Experience = () => {
  const EXPERIENCE_LIST = [
    {
      ...
      explanation: '삶의 질을 높이는 Generative AI 서비스 (23.08 ~ 23.09)',
      historyInformation: ['200팀이 넘는 참가 팀 중 상위 40팀 예선 통과'],
    },
    {
      title: '프로그래머스 데브코스 4기',
      explanation: '프론트엔드 개발자 양성 교육 과정 (2023.6 ~ 2023.8)',
      historyInformation: [
    ...
    {
      title: '모던애자일 5기',
      explanation: 'SW 개발 동아리 (2023.3 ~ 2023.7)',
      historyInformation: [
  ...
  return (
    <section className="mt-14 flex flex-col gap-10">
      ...
      <div className="grid grid-cols-[1.5fr_2fr] gap-y-10">
        {EXPERIENCE_LIST.map(({ title, explanation, historyInformation }) => (
          <Fragment key={title}>
